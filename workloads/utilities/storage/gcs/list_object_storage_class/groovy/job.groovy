...
pipelineJob('Utilities/Storage/GCS/Object - List Storage Class') {
  description("""
    <br/><h3 style="margin-bottom: 10px;">List Storage Class</h3>
    <p>This job allows the user to inspect the storage class of objects stored in a GCS bucket.</p>
