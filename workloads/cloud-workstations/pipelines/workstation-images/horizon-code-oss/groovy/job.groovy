...
pipelineJob('Cloud-Workstations/Workstation-Images/Horizon Code OSS') {
  description("""
    ...
    <p>The Dockerfile specifies the base <code>code-oss</code> image and installs required packages and tools.</p>
  ...
  definition {
    cpsScm {
      ...
      scriptPath('workloads/cloud-workstations/pipelines/workstation-images/horizon-code-oss/Jenkinsfile')
    }
  }
}
