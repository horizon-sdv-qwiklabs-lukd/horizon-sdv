...
pipelineJob('Cloud-Workstations/Workstation-Images/Horizon Android Studio for Platform (ASfP)') {
  description("""
  ...
  definition {
    cpsScm {
      ...
      scriptPath('workloads/cloud-workstations/pipelines/workstation-images/horizon-asfp/Jenkinsfile')
    }
  }
}
