...
// Description:
// Groovy file for defining a Jenkins Pipeline Job for deleting MTK
// Connect testbenches.

pipelineJob('OpenBSW/Environment/Delete MTK Connect Testbench') {
  description("""
    ...
    <p>The test pipelines show the name of the Testbench in console logs, e.g.  <code>MTK_CONNECT_TESTBENCH=OpenBSW/Tests/POSIX-4</code></p>
