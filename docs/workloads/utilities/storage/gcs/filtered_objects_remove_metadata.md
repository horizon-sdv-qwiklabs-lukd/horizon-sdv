...
This pipeline allows the user to find all objects in a bucket path which have the specified metadata set and remove metadata item from the objects.
...
Key or key/value pair that will be removed
e.g. `key` or `key1=1`
