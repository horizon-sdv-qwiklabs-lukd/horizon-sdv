...
This pipeline allows users to add metadata (key/value pairs) to objects stored in a GCS bucket.
...
List of one or more key/value pairs to add to object metadata (e.g. `key1=1 key2=2`)
